...
let calculadora = {
    ...
    realizarSuma: function() {
        ...
        if (!isNaN(cantidad)) {
            ...
            this.resultados.suma.push(suma); // Almacenar resultado
    ...
    // Método para mostrar todos los resultados de una operación
    ...
    // Método para mostrar todos los resultados de todas las operaciones
